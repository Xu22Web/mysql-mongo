 ...
 * @description 无类型
 */
export declare enum AggregateNoneType {
    /**
     * @description
     */
    NONE = "none"
...
export interface AggregateProps {
     ...
     * @description 聚合值
     */
    $value: (AggregateMixParamType | AggregateMixParamType[] | AggregateSeachOptions)[];
}
/**
 * @description 聚合操作
 */
export interface AggregateCommand<T extends object = object> extends AggregateCommandLike {
    /**
     * @description 聚合模式
     * @param values
     */
