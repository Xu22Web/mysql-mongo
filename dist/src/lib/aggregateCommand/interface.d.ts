 ...
 * @description 简单布尔操作符
 */
export declare enum AggregateBooleanSimpleType {
    /**
     * @description 逻辑操作符 且
     * @param values
     */
 ...
 * @description 否定布尔操作符
 */
export declare enum AggregateBooleanNegativeType {
    /**
     * @description 逻辑操作符 非
     * @param values
     */
 ...
 * @description 简单比较操作
 */
export declare enum AggregateCompareSimpleType {
    CMP = "cmp",
    /**
 ...
 * @description 筛选比较操作
 */
export declare enum AggregateCompareFilterType {
    /**
 ...
 * @description 简单算数类型
 */
export declare enum AggregateCalculationSimpleType {
    /**
     * @description  加法
     * @param values
     */
 ...
 * @description 算数函数类型
 */
export declare enum AggregateCalculationFunctionType {
    /**
     * @description 绝对值
     * @param values
     */
 ...
 * @description 字符串函数类型
 */
export declare enum AggregateStringType {
    /**
     * @description 去除收尾空格
     * @param values
     */
 ...
 * @description 累计器操作符
 */
export declare enum AggregateAccumulationType {
    /**
     * @description 平均数
     * @param values
     */
 ...
 * @description 条件操作符
 */
export declare enum AggregateConditionType {
    /**
     * @description 布尔表达式
     * @param values
     */
 ...
 * @description 算术操作符
 */
export type AggregateCalculationType = AggregateCalculationFunctionType | AggregateCalculationSimpleType;
/**
 * @description 布尔操作符
 */
export type AggregateBooleanType = AggregateBooleanSimpleType | AggregateBooleanNegativeType;
/**
 * @description 比较操作符
 */
export type AggregateCompareType = AggregateCompareSimpleType | AggregateCompareFilterType;
/**
 * @description 聚合操作类型
 */
export type AggregateCommandType = AggregateCalculationType | AggregateBooleanType | AggregateCompareType | AggregateStringType | AggregateAccumulationType | AggregateConditionType | AggregateJsonType;
/**
 * @description 特殊类型属性
 */
export type SpecificTypeProps<T extends object, K> = {
    [U in keyof T]: U extends string ? T[U] extends K ? U : T[U] extends unknown[] ? SpecificTypePropsArrayValue<U, T[U], K> : T[U] extends object ? SpecificTypePropsValue<U, T[U], K> : never : never;
}[keyof T];
/**
 * @description 特殊类型属性值
 */
export type SpecificTypePropsArrayValue<T extends string, K extends unknown[], U> = K extends U ? `${T}` : '0' extends keyof K ? SpecificTypePropsValue<T, K, U> : K extends (infer M)[] ? M extends U ? `${T}[${number}]` : M extends unknown[] ? SpecificTypePropsArrayValue<`${T}[${number}]`, M, U> : M extends object ? SpecificTypePropsValue<`${T}[${number}]`, M, U> : never : never;
/**
 * @description
 */
export type SpecificTypePropsValue<T extends string, K extends object, U> = {
    [M in keyof K]: M extends `${number}` ? K[M] extends U ? `${T}[${M}]` : K[M] extends unknown[] ? SpecificTypePropsArrayValue<`${T}[${M}]`, K[M], U> : K[M] extends object ? SpecificTypePropsValue<`${T}[${M}]`, K[M], U> : never : M extends string ? K[M] extends U ? `${T}.${M}` : K[M] extends unknown[] ? SpecificTypePropsArrayValue<`${T}.${M}`, K[M], U> : K[M] extends object ? SpecificTypePropsValue<`${T}.${M}`, K[M], U> : never : never;
}[keyof K];
/**
 * @description 聚合操作参数条件
 */
export type AggregateParamType<T extends object, K> = AggregateCommandLike | AggregateKey<SpecificTypeProps<T, K>> | K | null;
/**
 * @description 聚合操作参数类型（混合型）
 */
export type AggregateMixParamType<T extends object = object> = AggregateParamType<T, string | number | boolean | SQLJsonObject | SQLJsonArray>;
/**
 * @description 聚合操作参数类型（简单型）
 */
export type AggregateSimpleParamType<T extends object = object> = AggregateParamType<T, string | number | boolean>;
/**
 * @description 聚合操作参数类型（对象型）
 */
export type AggregateJsonParamType<T extends object = object> = AggregateParamType<T, SQLJsonObject | SQLJsonArray>;
/**
 * @description 聚合操作参数类型（对象型）
 */
export type AggregateObjectParamType<T extends object = object> = AggregateParamType<T, SQLJsonObject>;
/**
 * @description 聚合操作参数类型（对数组型）
 */
export type AggregateArrayParamType<T extends object = object> = AggregateParamType<T, SQLJsonArray>;
/**
 * @description 聚合操作参数类型（对象型）
 */
export type AggregateKeyParamType<T extends object = object> = AggregateParamType<T, never>;
/**
 * @description 聚合操作参数类型（数字型）
 */
export type AggregateNumberParamType<T extends object = any> = AggregateParamType<T, number>;
/**
 * @description 聚合操作参数类型（字符串型）
 */
export type AggregateStringParamType<T extends object> = AggregateParamType<T, string>;
/**
 * @description 类聚合操作类型
 */
export type AggregateCommandLike<K extends object = any, T extends AggregateCommandType = any, V extends (AggregateMixParamType<K> | AggregateMixParamType<K>[] | AggregateSeachOptions)[] = any> = {
 ...
 * @description 聚合操作
 */
export interface AggregateCommand<K extends object = any, T extends AggregateCommandType = any, V extends (AggregateMixParamType<K> | AggregateMixParamType<K>[] | AggregateSeachOptions)[] = any> {
    /**
     * @description 聚合模式
     * @param values
     */
