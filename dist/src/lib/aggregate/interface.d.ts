 ...
 * @description 任务类型
 */
export declare enum AggregateTaskType {
    NEWFIELDS = 0,
    GROUPBY = 1,
    MATCH = 2,
    FILTER = 3,
...
export type AggregateTask = {
    ...
    $value: AggregateFields | AggregateFilter | AggregateMatch | AggregateSort | AggregateGroup | number | string | boolean | null | (number | string | boolean | null | AggregateCommandLike | AggregateKey)[];
};
