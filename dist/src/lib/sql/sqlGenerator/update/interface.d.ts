...
import { SQLGenerator, SQLLimit, SQLName, SQLOrderBy, SQLRecord, SQLTypes, SQLWhere } from '../interface';
/**
 * @description update 语句所有片段名
 */
export declare enum UpdateClipNames {
    NAME = 0,
    WHERE = 1,
    ORDERBY = 2,
    LIMIT = 3,
 ...
 */
export type UpdatePropValue<T> = T extends 'name' ? SQLName : T extends 'where' ? SQLWhere : T extends 'orderby' ? SQLOrderBy : T extends 'limit' ? SQLLimit : T extends 'record' ? SQLRecord : never;
/**
