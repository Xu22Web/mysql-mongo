...
import { AggregateCommandLike, AggregateKey } from '../../aggregateCommand/interface';
 ...
 * @description 片段类型
 */
export type ClipName = SelectClipName | InsertClipName | DeleteClipName | UpdateClipName;
/**
 * @description 属性值
 */
export type PropValues = SQLName | SQLFields | SQLNewFields | SQLWhere | SQLGroupBy | SQLOrderBy | SQLHaving | SQLRecord | SQLLimit | SQLSkip | SQLGenerator;
/**
 * @description 新字段
 */
export type SQLNewFields = {
    [key: string]: AggregateCommandLike | AggregateKey | boolean | number | string | null | undefined;
};
/**
 * @description 字段
 */
