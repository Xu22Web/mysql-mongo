...
import { SQLGenerator, SQLLimit, SQLName, SQLOrderBy, SQLSkip, SQLTypes, SQLWhere } from '../interface';
/**
 * @description delete 语句所有片段名
 */
export declare enum DeleteClipNames {
    NAME = 0,
    WHERE = 1,
    ORDERBY = 2,
    LIMIT = 3
 ...
 */
export type DeletePropValue<T> = T extends 'name' ? SQLName : T extends 'where' ? SQLWhere : T extends 'orderby' ? SQLOrderBy : T extends 'limit' ? SQLSkip : never;
/**
