import { AggregateCommand, AggregateCommandLike, AggregateMixParamType, AggregateProps } from '../../../aggregateCommand/interface';
import { SQLJson } from '../../sqlGenerator/interface';
/**
 * @description SQLAggregateCommandClip
 */
export type SQLAggregateCommandClip<T = Omit<AggregateCommand, '$mode' | '$value' | '$type'>> = {
