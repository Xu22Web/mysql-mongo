 ...
 * @description 无类型
 */
export declare enum CommandNoneType {
    /**
     * @description
     */
    NONE = "none"
 ...
 * @description 逻辑操作符
 */
export declare enum CommandLogicSimpleType {
    /**
     * @description 逻辑操作符 且
     */
    AND = "and",
 ...
 * @description 否定逻辑操作符
 */
export declare enum CommandLogicNegativeType {
    /**
     * @description 逻辑操作符 非
     */
    NOT = "!",
 ...
 * @description 简单比较操作
 */
export declare enum CommandCompareSimpleType {
    /**
 ...
 * @description 筛选比较操作
 */
export declare enum CommandCompareFilterType {
    /**
 ...
 * @description 逻辑操作符
 */
export type CommandLogicType = CommandLogicSimpleType | CommandLogicNegativeType;
/**
 * @description 比较操作符
 */
export type CommandCompareType = CommandCompareSimpleType | CommandCompareFilterType;
/**
 * @description 命令操作符
 */
export type CommandType = CommandNoneType | CommandLogicType | CommandCompareType;
/**
 * @description 命令模式
 */
 ...
 */
export type CommandMixParamType = CommandParamsType<string | number | boolean | SQLJson | null>;
/**
