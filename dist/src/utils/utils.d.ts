...
import { AggregateKey, AggregateProps } from '../lib/aggregateCommand/interface';
 ...
 * @returns
 */
export declare const isAggregateCommand: (value: any) => value is AggregateProps;
/**
 * @description 是命令操作
 * @param value
 * @returns
 */
export declare const isCommand: (value: any) => value is CommandProps;
